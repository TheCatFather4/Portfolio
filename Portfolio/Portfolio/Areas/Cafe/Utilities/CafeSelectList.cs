...
namespace Portfolio.Areas.Cafe.Utilities
{
    /// <summary>
    /// An interface for the select list builder.
    /// </summary>
    public interface ICafeSelectList
    {
        /// <summary>
    ...
    /// </summary>
    public class CafeSelectList : ICafeSelectList
    {
        ...
        public CafeSelectList(IMenuRetrievalService menuService, IPaymentService paymentService)
        {
